    ...
    <Container className="intro-grid search-page">
      <section className="hero hero--split search-hero">
        <div className="hero__copy">
          ...
          <h1 className="hero__title">Encontrar a cidade dentro do site.</h1>
          <p className="hero__lead">
            Busque temas, casos, lugares, atores, campanhas, impactos, memórias e documentos sem atravessar camadas separadas. A consulta passa pelo arquivo inteiro.
          </p>
        ...
        <article className="support-box home-callout home-callout--accent">
          ...
          <p>
            Se você não sabe exatamente por onde entrar, comece pelo nome mais óbvio. Depois refine por tipo, território ou ator.
          </p>
      ...
      <section className="section search-results-section">
        ...
        {search.results.length ? (
          ...
          <article className="support-box search-empty">
            ...
            <p>
              A busca funciona melhor quando você entra pelo nome de um caso, lugar, ator ou documento. Se quiser, volte para o radar e siga por ali.
            </p>
            <div className="stack-actions">
              <Link href="/agora" className="button">
                Ver radar
